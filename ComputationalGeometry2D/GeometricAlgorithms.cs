...
namespace ComputationalGeometry2D
{
    public class GeometricAlgorithms
    {
        ...
        public List<Intersection> SegmentIntersection(List<LineSegment> segments)
        {
            ...
            double oldSweepLineY = eventQueue.FindMin().PointValue.Y;
            while (eventQueue.Count > 0) 
            {
                ...
                if (eventPointValue.Y.IsLessThanAndNotAlmostEqualTo(oldSweepLineY))
                    oldSweepLineY = eventPointValue.Y;
